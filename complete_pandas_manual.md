...
- [Part I: pandas Fundamentals and Workflow](#part-i-pandas-fundamentals-and-workflow)
  - [Subpart I-A: Orientation and Setup](#subpart-i-a-orientation-and-setup)
    - [1. How to Use This Manual](#1-how-to-use-this-manual)
      - [1.1 Areas of focus](#11-areas-of-focus)
  ...
  - [Subpart I-B: DataFrame Basics](#subpart-i-b-dataframe-basics)
    - [5. Core pandas Objects](#5-core-pandas-objects)
      ...
      - [5.3 Series vs DataFrame](#53-series-vs-dataframe)
    - [6. Creating DataFrames](#6-creating-dataframes)
      - [6.1 From a dictionary of lists](#61-from-a-dictionary-of-lists)
      - [6.2 From a list of dictionaries](#62-from-a-list-of-dictionaries)
      - [6.3 From a list of lists](#63-from-a-list-of-lists)
      - [6.4 Creating an empty DataFrame](#64-creating-an-empty-dataframe)
    - [7. Reading and Writing Files](#7-reading-and-writing-files)
      - [7.1 Read CSV](#71-read-csv)
      - [7.2 Write CSV](#72-write-csv)
      - [7.3 Read Excel](#73-read-excel)
      - [7.4 Write Excel](#74-write-excel)
      - [7.5 Read only specific columns](#75-read-only-specific-columns)
      - [7.6 Skip rows](#76-skip-rows)
      - [7.7 Set header row](#77-set-header-row)
      - [7.8 File formats and engines: `openpyxl`, `pyarrow`, and others](#78-file-formats-and-engines-openpyxl-pyarrow-and-others)
        - [Excel engines](#excel-engines)
        - [CSV engines](#csv-engines)
        - [Parquet and Arrow-oriented formats](#parquet-and-arrow-oriented-formats)
        - [Engine decision checklist](#engine-decision-checklist)
    - [8. Inspecting Data](#8-inspecting-data)
      - [8.1 First rows](#81-first-rows)
      - [8.2 Last rows](#82-last-rows)
      - [8.3 Shape](#83-shape)
      - [8.4 Column names](#84-column-names)
      - [8.5 Data types](#85-data-types)
      - [8.6 Summary info](#86-summary-info)
      - [8.7 Summary statistics](#87-summary-statistics)
      - [8.8 Unique values](#88-unique-values)
      - [8.9 Value counts](#89-value-counts)
  - [Subpart I-C: Selecting, Filtering, and Organizing Data](#subpart-i-c-selecting-filtering-and-organizing-data)
    - [9. Selecting Columns and Rows](#9-selecting-columns-and-rows)
      - [9.1 Select one column](#91-select-one-column)
      - [9.2 Select multiple columns](#92-select-multiple-columns)
    ...
    - [10. Filtering Data](#10-filtering-data)
      ...
      - [10.3 Multiple conditions with OR](#103-multiple-conditions-with-or)
      - [10.4 NOT condition](#104-not-condition)
      - [10.5 Filter with `isin`](#105-filter-with-isin)
      - [10.6 Filter text contains](#106-filter-text-contains)
      - [10.7 Filter missing values](#107-filter-missing-values)
      - [10.8 Query syntax](#108-query-syntax)
      - [10.9 Complex filter pattern: reusable masks](#109-complex-filter-pattern-reusable-masks)
      - [10.10 When to create masks, copies, and temporary DataFrames](#1010-when-to-create-masks-copies-and-temporary-dataframes)
    - [11. Creating, Updating, and Removing Columns](#11-creating-updating-and-removing-columns)
      - [11.1 Create a new column](#111-create-a-new-column)
      - [11.2 Create a column with conditional logic](#112-create-a-column-with-conditional-logic)
      - [11.3 Multiple conditions with `np.select`](#113-multiple-conditions-with-npselect)
      - [11.4 Update existing column](#114-update-existing-column)
      - [11.5 Update selected rows](#115-update-selected-rows)
      - [11.6 Drop a column](#116-drop-a-column)
      - [11.7 Rename columns](#117-rename-columns)
      - [11.8 Reorder columns](#118-reorder-columns)
      - [11.9 Complex custom column creation](#119-complex-custom-column-creation)
    - [12. Index Basics](#12-index-basics)
      - [12.1 Set a column as index](#121-set-a-column-as-index)
      - [12.2 Reset index](#122-reset-index)
      - [12.3 Why index matters](#123-why-index-matters)
    - [13. Sorting and Ranking](#13-sorting-and-ranking)
      - [13.1 Sort by one column](#131-sort-by-one-column)
      - [13.2 Sort by multiple columns](#132-sort-by-multiple-columns)
      - [13.3 Sort by index](#133-sort-by-index)
      - [13.4 Ranking](#134-ranking)
  - [Subpart I-D: Cleaning and Type-Specific Operations](#subpart-i-d-cleaning-and-type-specific-operations)
    - [14. Handling Missing Data](#14-handling-missing-data)
      - [14.1 Detect missing values](#141-detect-missing-values)
      - [14.2 Filter rows with missing values](#142-filter-rows-with-missing-values)
      - [14.3 Fill missing values](#143-fill-missing-values)
    ...
    - [15. Data Types and Type Conversion](#15-data-types-and-type-conversion)
      ...
      - [15.3 Convert to string](#153-convert-to-string)
      - [15.4 Convert to date](#154-convert-to-date)
      - [15.5 Convert to category](#155-convert-to-category)
    - [16. String/Text Operations](#16-stringtext-operations)
      - [16.1 Strip spaces](#161-strip-spaces)
      - [16.2 Uppercase/lowercase/title case](#162-uppercaselowercasetitle-case)
      - [16.3 Contains](#163-contains)
      - [16.4 Replace text](#164-replace-text)
      - [16.5 Split text](#165-split-text)
      - [16.6 Extract with regex](#166-extract-with-regex)
      - [16.7 Clean column names](#167-clean-column-names)
    - [17. Date and Time Operations](#17-date-and-time-operations)
      - [17.1 Convert to datetime](#171-convert-to-datetime)
      - [17.2 Extract date parts](#172-extract-date-parts)
      - [17.3 Format dates as text](#173-format-dates-as-text)
  ...
  - [Subpart I-E: Transformation, Aggregation, and Reshaping](#subpart-i-e-transformation-aggregation-and-reshaping)
    - [18. Conditional Logic in pandas](#18-conditional-logic-in-pandas)
      ...
      - [18.2 If/else with `np.where`](#182-ifelse-with-npwhere)
      - [18.3 Multiple conditions with `np.select`](#183-multiple-conditions-with-npselect)
      - [18.4 Conditional assignment with `loc`](#184-conditional-assignment-with-loc)
      - [18.5 Nested logic pattern](#185-nested-logic-pattern)
    - [19. Apply, Map, Replace, and Vectorization](#19-apply-map-replace-and-vectorization)
      - [19.1 Vectorized operations](#191-vectorized-operations)
      - [19.2 `map`](#192-map)
      - [19.3 `replace`](#193-replace)
      - [19.4 `apply` on a column](#194-apply-on-a-column)
    ...
    - [20. Grouping and Aggregation](#20-grouping-and-aggregation)
      ...
      - [20.3 Multiple aggregations](#203-multiple-aggregations)
      - [20.4 Group and count rows](#204-group-and-count-rows)
      - [20.5 Group and count non-missing values](#205-group-and-count-non-missing-values)
      - [20.6 Group by date period](#206-group-by-date-period)
      - [20.7 Transform](#207-transform)
      - [20.8 Complex grouping example: operational summary](#208-complex-grouping-example-operational-summary)
      - [20.9 Group filtering and top records within each group](#209-group-filtering-and-top-records-within-each-group)
    - [21. Pivot Tables and Cross Tabs](#21-pivot-tables-and-cross-tabs)
      - [21.1 Basic pivot table](#211-basic-pivot-table)
      - [21.2 Multiple values](#212-multiple-values)
      - [21.3 Add totals](#213-add-totals)
      - [21.4 Cross tab](#214-cross-tab)
    - [22. Reshaping Data](#22-reshaping-data)
      - [22.1 Wide vs long format](#221-wide-vs-long-format)
      - [22.2 Melt wide to long](#222-melt-wide-to-long)
      - [22.3 Pivot long to wide](#223-pivot-long-to-wide)
      - [22.4 Stack and unstack](#224-stack-and-unstack)
  - [Subpart I-F: Combining, Quality Checks, and Excel Outputs](#subpart-i-f-combining-quality-checks-and-excel-outputs)
    - [23. Combining DataFrames](#23-combining-dataframes)
      - [23.1 Concatenate rows](#231-concatenate-rows)
      - [23.2 Concatenate columns](#232-concatenate-columns)
      - [23.3 Merge like SQL joins](#233-merge-like-sql-joins)
      - [23.4 Join types](#234-join-types)
      - [23.5 Merge on different column names](#235-merge-on-different-column-names)
      - [23.6 Validate merge quality](#236-validate-merge-quality)
      - [23.7 Indicator column](#237-indicator-column)
      - [23.8 Complex example: joining multiple lookup tables](#238-complex-example-joining-multiple-lookup-tables)
      - [23.9 Merge audit pattern with `_merge`](#239-merge-audit-pattern-with-merge)
      - [23.10 `join` when the index is the key](#2310-join-when-the-index-is-the-key)
    - [24. Duplicates and Data Quality Checks](#24-duplicates-and-data-quality-checks)
      - [24.1 Find duplicate rows](#241-find-duplicate-rows)
      - [24.2 Find duplicate based on specific columns](#242-find-duplicate-based-on-specific-columns)
      - [24.3 Drop duplicates](#243-drop-duplicates)
      - [24.4 Basic quality checks](#244-basic-quality-checks)
      - [24.5 Validate required columns](#245-validate-required-columns)
    - [25. Working with Excel Reports](#25-working-with-excel-reports)
      - [25.1 Start by identifying the real table](#251-start-by-identifying-the-real-table)
      - [25.2 Read Excel safely](#252-read-excel-safely)
      - [25.3 Common `read_excel` import arguments](#253-common-readexcel-import-arguments)
      - [25.4 Skip title rows and footer rows](#254-skip-title-rows-and-footer-rows)
      - [25.5 Choose the correct header row](#255-choose-the-correct-header-row)
      - [25.6 Import only the rows and columns you need](#256-import-only-the-rows-and-columns-you-need)
      - [25.7 Preserve IDs, codes, and account numbers](#257-preserve-ids-codes-and-account-numbers)
      - [25.8 Use converters for custom import cleanup](#258-use-converters-for-custom-import-cleanup)
      - [25.9 Handle dates from Excel reports](#259-handle-dates-from-excel-reports)
      - [25.10 Control missing-value handling](#2510-control-missing-value-handling)
      - [25.11 Clean Excel column names](#2511-clean-excel-column-names)
      - [25.12 Remove blank rows, repeated headers, and total rows](#2512-remove-blank-rows-repeated-headers-and-total-rows)
      - [25.13 Unmerge-style cleanup with forward fill](#2513-unmerge-style-cleanup-with-forward-fill)
      - [25.14 Read every sheet and combine matching sheets](#2514-read-every-sheet-and-combine-matching-sheets)
      - [25.15 Validate the imported report before analysis](#2515-validate-the-imported-report-before-analysis)
      - [25.16 Save filtered results to Excel](#2516-save-filtered-results-to-excel)
      - [25.17 Save multiple outputs to one workbook](#2517-save-multiple-outputs-to-one-workbook)
      - [25.18 Basic Excel output formatting](#2518-basic-excel-output-formatting)
      - [25.19 Avoid common Excel problems](#2519-avoid-common-excel-problems)
      - [25.20 A complete messy-report import pattern](#2520-a-complete-messy-report-import-pattern)
- [Part II: Statistics](#part-ii-statistics)
  - [Subpart II-A: Calculating Statistics](#subpart-ii-a-calculating-statistics)
    - [26. Basic Statistics with pandas](#26-basic-statistics-with-pandas)
      - [26.1 Count](#261-count)
      - [26.2 Sum](#262-sum)
      - [26.3 Mean](#263-mean)
      - [26.4 Median](#264-median)
      - [26.5 Mode](#265-mode)
      - [26.6 Minimum and maximum](#266-minimum-and-maximum)
      - [26.7 Range](#267-range)
      - [26.8 Variance](#268-variance)
      - [26.9 Standard deviation](#269-standard-deviation)
      - [26.10 Percentiles and quantiles](#2610-percentiles-and-quantiles)
      - [26.11 Quartiles](#2611-quartiles)
      - [26.12 IQR](#2612-iqr)
      - [26.13 Outlier detection with IQR](#2613-outlier-detection-with-iqr)
      - [26.14 Correlation](#2614-correlation)
      - [26.15 Covariance](#2615-covariance)
      - [26.16 Skewness](#2616-skewness)
      - [26.17 `describe()`](#2617-describe)
      - [26.18 Multiple statistics at once](#2618-multiple-statistics-at-once)
      - [26.19 Grouped statistics](#2619-grouped-statistics)
      - [26.20 Numeric-column statistics only](#2620-numeric-column-statistics-only)
      - [26.21 Missing values in statistics](#2621-missing-values-in-statistics)
      - [26.22 Sample vs population standard deviation](#2622-sample-vs-population-standard-deviation)
      - [26.23 Percentages and proportions](#2623-percentages-and-proportions)
      - [26.24 Cross-tabulation](#2624-cross-tabulation)
      - [26.25 Weighted averages](#2625-weighted-averages)
      - [26.26 Coefficient of variation](#2626-coefficient-of-variation)
      - [26.27 Ranking and top-N analysis](#2627-ranking-and-top-n-analysis)
      - [26.28 A compact statistics report](#2628-a-compact-statistics-report)
  - [Subpart II-B: Interpreting Statistics](#subpart-ii-b-interpreting-statistics)
    - [27. Statistics Interpretation Guide](#27-statistics-interpretation-guide)
      - [27.1 The basic statistics decision table](#271-the-basic-statistics-decision-table)
      - [27.2 Count, missing values, and the denominator](#272-count-missing-values-and-the-denominator)
      - [27.3 Mean vs median](#273-mean-vs-median)
      - [27.4 Mode and value counts interpretation](#274-mode-and-value-counts-interpretation)
      - [27.5 Standard deviation interpretation](#275-standard-deviation-interpretation)
      - [27.6 Percentiles interpretation](#276-percentiles-interpretation)
      - [27.7 Quartiles and IQR interpretation](#277-quartiles-and-iqr-interpretation)
      - [27.8 Outlier interpretation](#278-outlier-interpretation)
      - [27.9 Correlation interpretation](#279-correlation-interpretation)
      - [27.10 Grouped statistics interpretation](#2710-grouped-statistics-interpretation)
      - [27.11 Percentages, rates, and shares](#2711-percentages-rates-and-shares)
      - [27.12 Weighted average interpretation](#2712-weighted-average-interpretation)
      - [27.13 Sample vs population interpretation](#2713-sample-vs-population-interpretation)
      - [27.14 Distribution shape: balanced, skewed, and multimodal](#2714-distribution-shape-balanced-skewed-and-multimodal)
      - [27.15 Practical interpretation checklist](#2715-practical-interpretation-checklist)
      - [27.16 A practical statistics workflow in pandas](#2716-a-practical-statistics-workflow-in-pandas)
        - [Step 1: Understand the rows and columns](#step-1-understand-the-rows-and-columns)
        - [Step 2: Check missingness](#step-2-check-missingness)
        - [Step 3: Summarize numeric columns](#step-3-summarize-numeric-columns)
        - [Step 4: Summarize categorical columns](#step-4-summarize-categorical-columns)
        - [Step 5: Compare groups](#step-5-compare-groups)
        - [Step 6: Check relationships](#step-6-check-relationships)
        - [Step 7: Write an insight statement](#step-7-write-an-insight-statement)
- [Part III: Charts and Plots](#part-iii-charts-and-plots)
  - [Subpart III-A: Chart Foundations for Statistics](#subpart-iii-a-chart-foundations-for-statistics)
    - [28. Charts for Understanding Statistics](#28-charts-for-understanding-statistics)
      - [28.1 Mean, median, and mode chart](#281-mean-median-and-mode-chart)
      - [28.2 Histogram distribution chart](#282-histogram-distribution-chart)
      - [28.3 Box plot chart](#283-box-plot-chart)
      - [28.4 Correlation heatmap](#284-correlation-heatmap)
      - [28.5 Chart-reading foundations for non-mathematicians](#285-chart-reading-foundations-for-non-mathematicians)
      - [28.6 Insight vocabulary: what a chart can tell you](#286-insight-vocabulary-what-a-chart-can-tell-you)
      - [28.7 Chart integrity checklist](#287-chart-integrity-checklist)
      - [28.8 Chart selection decision table](#288-chart-selection-decision-table)
      - [28.9 Measures, dimensions, and grain](#289-measures-dimensions-and-grain)
      - [28.10 The chart title should contain the answer](#2810-the-chart-title-should-contain-the-answer)
      - [28.11 When not to make a chart](#2811-when-not-to-make-a-chart)
  - [Subpart III-B: Creating Plots](#subpart-iii-b-creating-plots)
    - [29. Plotting with pandas and Matplotlib](#29-plotting-with-pandas-and-matplotlib)
      - [29.1 Line plot](#291-line-plot)
      - [29.2 Bar plot](#292-bar-plot)
      - [29.3 Horizontal bar plot](#293-horizontal-bar-plot)
      - [29.4 Histogram](#294-histogram)
      - [29.5 Box plot](#295-box-plot)
      - [29.6 Scatter plot](#296-scatter-plot)
      - [29.7 Area plot](#297-area-plot)
      - [29.8 Pie chart](#298-pie-chart)
      - [29.9 Density plot](#299-density-plot)
      - [29.10 Correlation heatmap without seaborn](#2910-correlation-heatmap-without-seaborn)
      - [29.11 Save a plot](#2911-save-a-plot)
      - [29.12 Improve labels](#2912-improve-labels)
      - [29.13 Add reference lines and annotations](#2913-add-reference-lines-and-annotations)
      - [29.14 Format numbers for readable charts](#2914-format-numbers-for-readable-charts)
      - [29.15 Plot grouped summaries from pandas](#2915-plot-grouped-summaries-from-pandas)
      - [29.16 Small multiples for cleaner comparisons](#2916-small-multiples-for-cleaner-comparisons)
      - [29.17 Sort bars so the message is obvious](#2917-sort-bars-so-the-message-is-obvious)
      - [29.18 Show percentages as a 100% stacked bar](#2918-show-percentages-as-a-100-stacked-bar)
      - [29.19 Pareto chart for the biggest contributors](#2919-pareto-chart-for-the-biggest-contributors)
      - [29.20 Before-and-after comparison](#2920-before-and-after-comparison)
      - [29.21 Dual-axis charts: use carefully](#2921-dual-axis-charts-use-carefully)
      - [29.22 Plotting missing values intentionally](#2922-plotting-missing-values-intentionally)
      - [29.23 A reusable plotting pattern](#2923-a-reusable-plotting-pattern)
      - [29.24 Wide data vs long data for plotting](#2924-wide-data-vs-long-data-for-plotting)
      - [29.25 Grouped bar charts](#2925-grouped-bar-charts)
      - [29.26 Date axes and time order](#2926-date-axes-and-time-order)
      - [29.27 Data labels and annotations](#2927-data-labels-and-annotations)
      - [29.28 Color, accessibility, and emphasis](#2928-color-accessibility-and-emphasis)
      - [29.29 Saving charts for reports](#2929-saving-charts-for-reports)
  - [Subpart III-C: Reading Plot Types](#subpart-iii-c-reading-plot-types)
    - [30. How to Read Common Plot Types](#30-how-to-read-common-plot-types)
      - [30.1 Line plot](#301-line-plot)
      - [30.2 Bar plot](#302-bar-plot)
      - [30.3 Histogram](#303-histogram)
      - [30.4 Box plot](#304-box-plot)
      - [30.5 Scatter plot](#305-scatter-plot)
      - [30.6 Pie chart](#306-pie-chart)
      - [30.7 Heatmap](#307-heatmap)
      - [30.8 Which chart should I use?](#308-which-chart-should-i-use)
      - [30.9 What each chart type is not good for](#309-what-each-chart-type-is-not-good-for)
      - [30.10 Common misleading chart problems](#3010-common-misleading-chart-problems)
      - [30.11 Chart design rules that improve understanding](#3011-chart-design-rules-that-improve-understanding)
      - [30.12 Turning a chart into an insight statement](#3012-turning-a-chart-into-an-insight-statement)
      - [30.13 Chart-to-pandas workflow](#3013-chart-to-pandas-workflow)
      - [30.14 Dashboard and report review checklist](#3014-dashboard-and-report-review-checklist)
      - [30.15 Measures, dimensions, grain, and filters](#3015-measures-dimensions-grain-and-filters)
      - [30.16 Count, sum, average, percentage, and rate](#3016-count-sum-average-percentage-and-rate)
      - [30.17 Reading trends over time](#3017-reading-trends-over-time)
      - [30.18 Reading category comparisons](#3018-reading-category-comparisons)
      - [30.19 Reading distributions without advanced math](#3019-reading-distributions-without-advanced-math)
      - [30.20 Reading relationships without assuming causation](#3020-reading-relationships-without-assuming-causation)
      - [30.21 Chart captions for business reports](#3021-chart-captions-for-business-reports)
      - [30.22 Choosing colors for clarity and accessibility](#3022-choosing-colors-for-clarity-and-accessibility)
      - [30.23 When a table is better than a chart](#3023-when-a-table-is-better-than-a-chart)
      - [30.24 From question to final chart: a complete mini-example](#3024-from-question-to-final-chart-a-complete-mini-example)
- [Part IV: Applied pandas and Reference](#part-iv-applied-pandas-and-reference)
  - [Subpart IV-A: Applied Workflows and Performance](#subpart-iv-a-applied-workflows-and-performance)
    - [31. Practical Orders and Inventory Example](#31-practical-orders-and-inventory-example)
      - [31.1 Create sample order and inventory data](#311-create-sample-order-and-inventory-data)
      - [31.2 Calculate variance](#312-calculate-variance)
      - [31.3 Categorize budget status](#313-categorize-budget-status)
      - [31.4 Detect possible quantity issue](#314-detect-possible-quantity-issue)
      - [31.5 Create a final tag](#315-create-a-final-tag)
      - [31.6 Summary by customer](#316-summary-by-customer)
      - [31.7 Summary by reviewer](#317-summary-by-reviewer)
      - [31.8 Export results](#318-export-results)
    - [32. Method Chaining](#32-method-chaining)
    - [33. Performance Tips](#33-performance-tips)
      - [33.1 Prefer vectorized operations](#331-prefer-vectorized-operations)
      - [33.2 Avoid building DataFrames row by row](#332-avoid-building-dataframes-row-by-row)
      - [33.3 Read only needed rows and columns](#333-read-only-needed-rows-and-columns)
      - [33.4 Choose efficient data types](#334-choose-efficient-data-types)
      - [33.5 Check memory usage](#335-check-memory-usage)
      - [33.6 Process large files in chunks](#336-process-large-files-in-chunks)
      - [33.7 Avoid repeated calculations](#337-avoid-repeated-calculations)
      - [33.8 Sort only when sorting matters](#338-sort-only-when-sorting-matters)
      - [33.9 Use indexes intentionally](#339-use-indexes-intentionally)
      - [33.10 Use the right file format for repeated work](#3310-use-the-right-file-format-for-repeated-work)
      - [33.11 Measure before optimizing](#3311-measure-before-optimizing)
      - [33.12 Performance checklist](#3312-performance-checklist)
  - [Subpart IV-B: Advanced pandas Operations](#subpart-iv-b-advanced-pandas-operations)
    - [34. Additional pandas Operations](#34-additional-pandas-operations)
      - [34.1 `where` and `mask`](#341-where-and-mask)
      - [34.2 `clip`](#342-clip)
      - [34.3 `assign`](#343-assign)
      - [34.4 `pipe`](#344-pipe)
      - [34.5 `explode`](#345-explode)
      - [34.6 `nlargest` and `nsmallest`](#346-nlargest-and-nsmallest)
      - [34.7 Sampling data](#347-sampling-data)
      - [34.8 Random state](#348-random-state)
      - [34.9 `value_counts` for multiple columns](#349-valuecounts-for-multiple-columns)
      - [34.10 Percent of total](#3410-percent-of-total)
      - [34.11 Difference between rows](#3411-difference-between-rows)
      - [34.12 Percentage change](#3412-percentage-change)
      - [34.13 Cumulative sum](#3413-cumulative-sum)
      - [34.14 Cumulative count](#3414-cumulative-count)
      - [34.15 Rank within group](#3415-rank-within-group)
      - [34.16 `idxmax` and `idxmin`](#3416-idxmax-and-idxmin)
      - [34.17 `select_dtypes`](#3417-selectdtypes)
      - [34.18 Memory-friendly categorical columns](#3418-memory-friendly-categorical-columns)
    - [35. MultiIndex and Hierarchical Data](#35-multiindex-and-hierarchical-data)
      - [35.1 Create a MultiIndex through groupby](#351-create-a-multiindex-through-groupby)
      - [35.2 Convert MultiIndex result back to normal columns](#352-convert-multiindex-result-back-to-normal-columns)
      - [35.3 Set a MultiIndex manually](#353-set-a-multiindex-manually)
      - [35.4 Select from a MultiIndex](#354-select-from-a-multiindex)
      - [35.5 Sort a MultiIndex](#355-sort-a-multiindex)
      - [35.6 Unstack a MultiIndex](#356-unstack-a-multiindex)
      - [35.7 Stack back to long format](#357-stack-back-to-long-format)
      - [35.8 When to avoid MultiIndex](#358-when-to-avoid-multiindex)
    - [36. Cumulative, Rolling, and Window Calculations](#36-cumulative-rolling-and-window-calculations)
      - [36.1 Cumulative sum](#361-cumulative-sum)
      - [36.2 Cumulative maximum](#362-cumulative-maximum)
      - [36.3 Rolling average](#363-rolling-average)
      - [36.4 Rolling sum](#364-rolling-sum)
      - [36.5 Expanding average](#365-expanding-average)
      - [36.6 Rolling by group](#366-rolling-by-group)
      - [36.7 When rolling calculations are useful](#367-when-rolling-calculations-are-useful)
    - [37. Binning, Bucketing, and Segmentation](#37-binning-bucketing-and-segmentation)
      - [37.1 Fixed bins with `cut`](#371-fixed-bins-with-cut)
      - [37.2 Equal-sized groups with `qcut`](#372-equal-sized-groups-with-qcut)
      - [37.3 Count records by bucket](#373-count-records-by-bucket)
      - [37.4 Summarize by bucket](#374-summarize-by-bucket)
      - [37.5 When buckets are useful](#375-when-buckets-are-useful)
    - [38. Working with Many Files and JSON](#38-working-with-many-files-and-json)
      - [38.1 Read all CSV files in a folder](#381-read-all-csv-files-in-a-folder)
      - [38.2 Read all Excel files in a folder](#382-read-all-excel-files-in-a-folder)
      - [38.3 Skip temporary Excel files](#383-skip-temporary-excel-files)
      - [38.4 Standardize columns while combining files](#384-standardize-columns-while-combining-files)
      - [38.5 Validate required columns after combining files](#385-validate-required-columns-after-combining-files)
      - [38.6 Read JSON](#386-read-json)
      - [38.7 Normalize nested JSON](#387-normalize-nested-json)
      - [38.8 Create an error report while processing files](#388-create-an-error-report-while-processing-files)
  - [Subpart IV-C: SQL Data Access for pandas](#subpart-iv-c-sql-data-access-for-pandas)
    - [39. SQL for pandas and Python Data Work](#39-sql-for-pandas-and-python-data-work)
      - [39.1 When to use SQL before pandas](#391-when-to-use-sql-before-pandas)
      - [39.2 The basic shape of a SQL query](#392-the-basic-shape-of-a-sql-query)
      - [39.3 Start every query by defining the row grain](#393-start-every-query-by-defining-the-row-grain)
      - [39.4 Basic connection patterns](#394-basic-connection-patterns)
      - [39.5 Preview tables and understand schema](#395-preview-tables-and-understand-schema)
      - [39.6 Select columns intentionally](#396-select-columns-intentionally)
      - [39.7 Filter rows in SQL before loading](#397-filter-rows-in-sql-before-loading)
      - [39.8 Use parameters instead of string formatting](#398-use-parameters-instead-of-string-formatting)
      - [39.9 Sort and limit for safe previews](#399-sort-and-limit-for-safe-previews)
      - [39.10 Create calculated columns in SQL](#3910-create-calculated-columns-in-sql)
      - [39.11 Join database tables before pandas](#3911-join-database-tables-before-pandas)
      - [39.12 Aggregate in SQL to reduce data volume](#3912-aggregate-in-sql-to-reduce-data-volume)
      - [39.13 Build queries step by step](#3913-build-queries-step-by-step)
      - [39.14 Read large SQL results in chunks](#3914-read-large-sql-results-in-chunks)
      - [39.15 Control data types after reading SQL](#3915-control-data-types-after-reading-sql)
      - [39.16 Write a DataFrame to SQL](#3916-write-a-dataframe-to-sql)
      - [39.17 Append results safely](#3917-append-results-safely)
      - [39.18 Use transactions for write workflows](#3918-use-transactions-for-write-workflows)
      - [39.19 SQL query checklist before loading to pandas](#3919-sql-query-checklist-before-loading-to-pandas)
      - [39.20 SQL-to-pandas troubleshooting](#3920-sql-to-pandas-troubleshooting)
  - [Subpart IV-D: Reporting and Troubleshooting](#subpart-iv-d-reporting-and-troubleshooting)
    - [40. Styling Tables and Creating Review Outputs](#40-styling-tables-and-creating-review-outputs)
      - [40.1 Format numbers for display](#401-format-numbers-for-display)
      - [40.2 Highlight maximum values](#402-highlight-maximum-values)
      - [40.3 Highlight minimum values](#403-highlight-minimum-values)
      - [40.4 Conditional formatting with a custom function](#404-conditional-formatting-with-a-custom-function)
      - [40.5 Export styled DataFrame to Excel](#405-export-styled-dataframe-to-excel)
      - [40.6 Create a review workbook](#406-create-a-review-workbook)
      - [40.7 Add an audit summary sheet](#407-add-an-audit-summary-sheet)
    - [41. Common Errors and How to Fix Them](#41-common-errors-and-how-to-fix-them)
      - [41.1 KeyError: column not found](#411-keyerror-column-not-found)
      - [41.2 TypeError when doing math](#412-typeerror-when-doing-math)
      - [41.3 SettingWithCopyWarning](#413-settingwithcopywarning)
      - [41.4 Dates not working](#414-dates-not-working)
  ...
  - [Subpart IV-E: Quick Reference](#subpart-iv-e-quick-reference)
    - [42. Mini Cheat Sheet](#42-mini-cheat-sheet)
      ...
      - [Sort, rank, and get top/bottom records](#sort-rank-and-get-topbottom-records)
      - [Clean column names and values](#clean-column-names-and-values)
      - [Missing data](#missing-data)
      - [Data types and conversions](#data-types-and-conversions)
      - [Dates and times](#dates-and-times)
      - [String/text operations](#stringtext-operations)
      - [Create and update columns](#create-and-update-columns)
      - [Group and aggregate](#group-and-aggregate)
      - [Pivot tables and cross tabs](#pivot-tables-and-cross-tabs)
      - [Reshape data](#reshape-data)
      - [Merge, join, and concatenate](#merge-join-and-concatenate)
      - [Duplicates and data quality checks](#duplicates-and-data-quality-checks)
      - [Statistics](#statistics)
      - [Cumulative, rolling, and window calculations](#cumulative-rolling-and-window-calculations)
      - [Binning and segmentation](#binning-and-segmentation)
      - [Method chaining pattern](#method-chaining-pattern)
      - [Excel reporting](#excel-reporting)
      - [Plot](#plot)
      - [SQL with pandas](#sql-with-pandas)
      - [Display formatting](#display-formatting)
      - [Common pandas reminders](#common-pandas-reminders)
